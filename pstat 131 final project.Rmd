...
spotify_fold <- vfold_cv(spotify_train, strata = artist_name, v = 5)

spotify_recipe <- recipe(track_name ~ artist_name + ms_played + date                          +seconds + minutes,
                         data = spotify_train) %>%
                  step_dummy(c(track_name, ms_played))%>%
